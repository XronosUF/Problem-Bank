...
Estimate the area under the graph of $f(x)={-x - 1}$ from $x={-5}$ to $x={-1}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 5}$ from $x={5}$ to $x={11}$ using ${6}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 5}$ from $x={1}$ to $x={5}$ using ${4}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 10}$ from $x={7}$ to $x={10}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 2}$ from $x={2}$ to $x={6}$ using ${4}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x - 2}$ from $x={-6}$ to $x={-2}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 6}$ from $x={6}$ to $x={9}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 1}$ from $x={-1}$ to $x={6}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 10}$ from $x={4}$ to $x={10}$ using ${6}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 9}$ from $x={2}$ to $x={9}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2}}$ from $x={-5}$ to $x={0}$ using ${5}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 3}$ from $x={3}$ to $x={9}$ using ${6}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 10}$ from $x={6}$ to $x={10}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 1}$ from $x={-4}$ to $x={1}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 4}$ from $x={-4}$ to $x={1}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 3}$ from $x={-3}$ to $x={0}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 4}$ from $x={-1}$ to $x={2}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 1}$ from $x={1}$ to $x={5}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 3}$ from $x={-3}$ to $x={4}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 11}$ from $x={6}$ to $x={11}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 3}$ from $x={3}$ to $x={10}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x - 3}$ from $x={-8}$ to $x={-3}$ using ${5}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 49}$ from $x={1}$ to $x={7}$ using ${6}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 36}$ from $x={-1}$ to $x={6}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.

\input{Integral-Compute-0001.HELP.tex}

\[\mbox{Area}\approx\answer{161}\]
\end{problem}}%}
...
Estimate the area under the graph of $f(x)={x^{2} - 4}$ from $x={-6}$ to $x={-2}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 3}$ from $x={-4}$ to $x={3}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 2}$ from $x={2}$ to $x={7}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 25}$ from $x={5}$ to $x={10}$ using ${5}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 5}$ from $x={5}$ to $x={9}$ using ${4}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 16}$ from $x={-4}$ to $x={0}$ using ${4}$ rectangles and ${\text{left}}$ endpoints.

\input{Integral-Compute-0001.HELP.tex}

\[\mbox{Area}\approx\answer{34}\]
\end{problem}}%}
...
Estimate the area under the graph of $f(x)={-x + 12}$ from $x={7}$ to $x={12}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 5}$ from $x={-2}$ to $x={5}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 11}$ from $x={5}$ to $x={11}$ using ${6}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 36}$ from $x={1}$ to $x={6}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.

\input{Integral-Compute-0001.HELP.tex}

\[\mbox{Area}\approx\answer{125}\]
\end{problem}}%}
...
Estimate the area under the graph of $f(x)={-x + 9}$ from $x={2}$ to $x={9}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 64}$ from $x={-8}$ to $x={-4}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 4}$ from $x={4}$ to $x={7}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 7}$ from $x={-7}$ to $x={-1}$ using ${6}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 1}$ from $x={1}$ to $x={4}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 9}$ from $x={3}$ to $x={7}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 2}$ from $x={-5}$ to $x={2}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 9}$ from $x={-3}$ to $x={1}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 4}$ from $x={-2}$ to $x={4}$ using ${6}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 8}$ from $x={3}$ to $x={8}$ using ${5}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 1}$ from $x={-6}$ to $x={-1}$ using ${5}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 49}$ from $x={7}$ to $x={11}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 13}$ from $x={7}$ to $x={13}$ using ${6}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 9}$ from $x={-3}$ to $x={3}$ using ${6}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 4}$ from $x={-4}$ to $x={0}$ using ${4}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 2}$ from $x={-2}$ to $x={1}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 1}$ from $x={1}$ to $x={7}$ using ${6}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 9}$ from $x={3}$ to $x={7}$ using ${4}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 4}$ from $x={-1}$ to $x={4}$ using ${5}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 9}$ from $x={5}$ to $x={9}$ using ${4}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 16}$ from $x={-3}$ to $x={4}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 1}$ from $x={-1}$ to $x={2}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 25}$ from $x={-1}$ to $x={5}$ using ${6}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 3}$ from $x={3}$ to $x={8}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 6}$ from $x={6}$ to $x={10}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 144}$ from $x={5}$ to $x={12}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 49}$ from $x={-7}$ to $x={-2}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 8}$ from $x={8}$ to $x={15}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 49}$ from $x={7}$ to $x={14}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 7}$ from $x={3}$ to $x={7}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 2}$ from $x={2}$ to $x={5}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 9}$ from $x={-6}$ to $x={-3}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 64}$ from $x={8}$ to $x={13}$ using ${5}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 11}$ from $x={4}$ to $x={11}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 1}$ from $x={1}$ to $x={7}$ using ${6}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 144}$ from $x={7}$ to $x={12}$ using ${5}$ rectangles and ${\text{right}}$ endpoints.

\input{Integral-Compute-0001.HELP.tex}

\[\mbox{Area}\approx\answer{210}\]
\end{problem}}%}
...
Estimate the area under the graph of $f(x)={-x^{2} + 196}$ from $x={7}$ to $x={14}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.

\input{Integral-Compute-0001.HELP.tex}

\[\mbox{Area}\approx\answer{644}\]
\end{problem}}%}
...
Estimate the area under the graph of $f(x)={x - 6}$ from $x={6}$ to $x={9}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 49}$ from $x={-7}$ to $x={0}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 7}$ from $x={4}$ to $x={7}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 4}$ from $x={-4}$ to $x={2}$ using ${6}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 100}$ from $x={7}$ to $x={10}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 3}$ from $x={-1}$ to $x={3}$ using ${4}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 14}$ from $x={7}$ to $x={14}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 1}$ from $x={-1}$ to $x={5}$ using ${6}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 1}$ from $x={1}$ to $x={6}$ using ${5}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 3}$ from $x={3}$ to $x={6}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 1}$ from $x={-1}$ to $x={3}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 36}$ from $x={6}$ to $x={9}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 16}$ from $x={-4}$ to $x={3}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 5}$ from $x={-5}$ to $x={-2}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 4}$ from $x={2}$ to $x={5}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 4}$ from $x={-2}$ to $x={4}$ using ${6}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 4}$ from $x={2}$ to $x={8}$ using ${6}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 8}$ from $x={-8}$ to $x={-2}$ using ${6}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 1}$ from $x={-4}$ to $x={1}$ using ${5}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 4}$ from $x={-7}$ to $x={-2}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 6}$ from $x={6}$ to $x={13}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 12}$ from $x={5}$ to $x={12}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 9}$ from $x={-1}$ to $x={3}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 3}$ from $x={-3}$ to $x={1}$ using ${4}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 64}$ from $x={8}$ to $x={12}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x - 1}$ from $x={-8}$ to $x={-1}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 12}$ from $x={6}$ to $x={12}$ using ${6}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 12}$ from $x={5}$ to $x={12}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 8}$ from $x={-8}$ to $x={-4}$ using ${4}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 49}$ from $x={7}$ to $x={10}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 16}$ from $x={-2}$ to $x={4}$ using ${6}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 4}$ from $x={1}$ to $x={4}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 64}$ from $x={-8}$ to $x={-3}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 4}$ from $x={4}$ to $x={8}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x}$ from $x={-4}$ to $x={0}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 49}$ from $x={-7}$ to $x={-4}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 1}$ from $x={-2}$ to $x={1}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 4}$ from $x={-2}$ to $x={2}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 36}$ from $x={-6}$ to $x={-2}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 1}$ from $x={-2}$ to $x={1}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 6}$ from $x={6}$ to $x={11}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 8}$ from $x={8}$ to $x={11}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 8}$ from $x={8}$ to $x={11}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 10}$ from $x={3}$ to $x={10}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 2}$ from $x={2}$ to $x={6}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 13}$ from $x={8}$ to $x={13}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 4}$ from $x={-4}$ to $x={2}$ using ${6}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 2}$ from $x={-3}$ to $x={2}$ using ${5}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 81}$ from $x={6}$ to $x={9}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x - 1}$ from $x={-6}$ to $x={-1}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 49}$ from $x={3}$ to $x={7}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 64}$ from $x={8}$ to $x={13}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 7}$ from $x={2}$ to $x={7}$ using ${5}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 16}$ from $x={-1}$ to $x={4}$ using ${5}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 4}$ from $x={-5}$ to $x={2}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 16}$ from $x={-4}$ to $x={0}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 36}$ from $x={-6}$ to $x={-1}$ using ${5}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 7}$ from $x={-7}$ to $x={0}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 121}$ from $x={8}$ to $x={11}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.

\input{Integral-Compute-0001.HELP.tex}

\[\mbox{Area}\approx\answer{61}\]
\end{problem}}%}
...
Estimate the area under the graph of $f(x)={-x + 3}$ from $x={-3}$ to $x={3}$ using ${6}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 169}$ from $x={8}$ to $x={13}$ using ${5}$ rectangles and ${\text{right}}$ endpoints.

\input{Integral-Compute-0001.HELP.tex}

\[\mbox{Area}\approx\answer{230}\]
\end{problem}}%}
...
Estimate the area under the graph of $f(x)={x^{2} - 1}$ from $x={-6}$ to $x={1}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 1}$ from $x={-1}$ to $x={3}$ using ${4}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 25}$ from $x={5}$ to $x={9}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 8}$ from $x={-8}$ to $x={-3}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 64}$ from $x={8}$ to $x={14}$ using ${6}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x}$ from $x={-5}$ to $x={0}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 121}$ from $x={4}$ to $x={11}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.

\input{Integral-Compute-0001.HELP.tex}

\[\mbox{Area}\approx\answer{371}\]
\end{problem}}%}
...
Estimate the area under the graph of $f(x)={x^{2} - 9}$ from $x={3}$ to $x={9}$ using ${6}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 9}$ from $x={-7}$ to $x={-3}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 16}$ from $x={-4}$ to $x={3}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 4}$ from $x={-1}$ to $x={2}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 5}$ from $x={5}$ to $x={12}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 36}$ from $x={-6}$ to $x={1}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.

\input{Integral-Compute-0001.HELP.tex}

\[\mbox{Area}\approx\answer{196}\]
\end{problem}}%}
...
Estimate the area under the graph of $f(x)={x^{2} - 25}$ from $x={-8}$ to $x={-5}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 1}$ from $x={1}$ to $x={8}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 7}$ from $x={1}$ to $x={7}$ using ${6}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 15}$ from $x={8}$ to $x={15}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 1}$ from $x={-2}$ to $x={1}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 9}$ from $x={3}$ to $x={6}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 7}$ from $x={7}$ to $x={12}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 36}$ from $x={-6}$ to $x={0}$ using ${6}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 1}$ from $x={1}$ to $x={8}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 1}$ from $x={-4}$ to $x={1}$ using ${5}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 8}$ from $x={5}$ to $x={8}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 144}$ from $x={6}$ to $x={12}$ using ${6}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 1}$ from $x={-6}$ to $x={1}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2}}$ from $x={-7}$ to $x={0}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 8}$ from $x={-8}$ to $x={-2}$ using ${6}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 36}$ from $x={2}$ to $x={6}$ using ${4}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 9}$ from $x={3}$ to $x={10}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 1}$ from $x={-1}$ to $x={6}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 4}$ from $x={-4}$ to $x={1}$ using ${5}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 1}$ from $x={-1}$ to $x={4}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 4}$ from $x={2}$ to $x={8}$ using ${6}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 144}$ from $x={8}$ to $x={12}$ using ${4}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 7}$ from $x={-7}$ to $x={-2}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 36}$ from $x={-6}$ to $x={-1}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 11}$ from $x={7}$ to $x={11}$ using ${4}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 1}$ from $x={-8}$ to $x={-1}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 64}$ from $x={8}$ to $x={12}$ using ${4}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 1}$ from $x={1}$ to $x={4}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 36}$ from $x={6}$ to $x={11}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 81}$ from $x={3}$ to $x={9}$ using ${6}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 5}$ from $x={5}$ to $x={8}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 3}$ from $x={-3}$ to $x={1}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 5}$ from $x={5}$ to $x={10}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 8}$ from $x={-8}$ to $x={-1}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 6}$ from $x={-6}$ to $x={-1}$ using ${5}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 8}$ from $x={8}$ to $x={15}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 1}$ from $x={-2}$ to $x={1}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.

\input{Integral-Compute-0001.HELP.tex}

\[\mbox{Area}\approx\answer{-1}\]
\end{problem}}%}
...
Estimate the area under the graph of $f(x)={-x^{2} + 64}$ from $x={-8}$ to $x={-1}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x - 1}$ from $x={-4}$ to $x={-1}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 3}$ from $x={-3}$ to $x={2}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 25}$ from $x={5}$ to $x={8}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 7}$ from $x={7}$ to $x={14}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 10}$ from $x={5}$ to $x={10}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 8}$ from $x={-8}$ to $x={-5}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 49}$ from $x={7}$ to $x={13}$ using ${6}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 8}$ from $x={8}$ to $x={12}$ using ${4}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 49}$ from $x={4}$ to $x={7}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 49}$ from $x={-7}$ to $x={-3}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 36}$ from $x={-6}$ to $x={1}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 16}$ from $x={4}$ to $x={8}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 6}$ from $x={1}$ to $x={6}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 9}$ from $x={-2}$ to $x={3}$ using ${5}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 7}$ from $x={7}$ to $x={10}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x}$ from $x={-7}$ to $x={0}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 100}$ from $x={7}$ to $x={10}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 7}$ from $x={7}$ to $x={13}$ using ${6}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 4}$ from $x={-7}$ to $x={-2}$ using ${5}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 11}$ from $x={7}$ to $x={11}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 1}$ from $x={-1}$ to $x={6}$ using ${7}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 36}$ from $x={3}$ to $x={6}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 3}$ from $x={-2}$ to $x={3}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 13}$ from $x={6}$ to $x={13}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 1}$ from $x={1}$ to $x={8}$ using ${7}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 25}$ from $x={-5}$ to $x={1}$ using ${6}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 16}$ from $x={-8}$ to $x={-4}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 6}$ from $x={6}$ to $x={10}$ using ${4}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 2}$ from $x={-2}$ to $x={3}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 9}$ from $x={3}$ to $x={9}$ using ${6}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x + 2}$ from $x={-2}$ to $x={4}$ using ${6}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 4}$ from $x={-8}$ to $x={-2}$ using ${6}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 5}$ from $x={-1}$ to $x={5}$ using ${6}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 4}$ from $x={2}$ to $x={6}$ using ${4}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 64}$ from $x={-8}$ to $x={-5}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 8}$ from $x={8}$ to $x={14}$ using ${6}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x - 3}$ from $x={-7}$ to $x={-3}$ using ${4}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 36}$ from $x={-6}$ to $x={0}$ using ${6}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x + 2}$ from $x={-4}$ to $x={2}$ using ${6}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 4}$ from $x={-2}$ to $x={1}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 144}$ from $x={6}$ to $x={12}$ using ${6}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x - 2}$ from $x={-7}$ to $x={-2}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x^{2} + 16}$ from $x={-4}$ to $x={-1}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x - 1}$ from $x={1}$ to $x={6}$ using ${5}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={x^{2} - 1}$ from $x={-1}$ to $x={2}$ using ${3}$ rectangles and ${\text{left}}$ endpoints.
...
Estimate the area under the graph of $f(x)={-x - 4}$ from $x={-7}$ to $x={-4}$ using ${3}$ rectangles and ${\text{right}}$ endpoints.
