...
\[
  \left(\answer{-\infty},\answer{\sage{-b}}\right)
  \bigcup
  \left(\answer{\sage{-b}},\answer{\infty}\right)
\]
...
%%%%%%%%%%%%%%%%%%%%%%%
%%\tagged{Ans@ShortAns, Type@Compute, Topic@Precalc, Sub@Linear, Sub@SystemOfEquations, File@0077}{
\begin{sagesilent}
# Define variables and constants/exponents
var('x,y')
a=NonZeroInt(-5,5)
...
\latexProblemContent{
\ifVerboseLocation This is Precalc Compute Question 0077. \\ \fi
\begin{problem}
...
\input{Precalc-Compute-0077.HELP.tex}

\[\left(\answer{\sage{AnsX}},\answer{\sage{AnsY}}\right) \]
...
%%%%%%%%%%%%%%%%%%%%%%%
%%\tagged{Ans@ShortAns, Type@Compute, Topic@Precalc, Sub@Linear, Sub@SystemOfEquations, File@0078}{
\begin{sagesilent}
# Define variables and constants/exponents
var('x,y,z')
a1=NonZeroInt(-5,5)
...
\latexProblemContent{
\ifVerboseLocation This is Precalc Compute Question 0078. \\ \fi
\begin{problem}
...
\input{Precalc-Compute-0078.HELP.tex}

\[\left(\answer{\sage{AnsX}},\answer{\sage{AnsY}}, \answer{\sage{AnsZ}}\right) \]
...
%%%%%%%%%%%%%%%%%%%%%%%
%%\tagged{Ans@ShortAns, Type@Compute, Topic@Precalc, Sub@Nonlinear, Sub@SystemOfEquations, File@0079}{
\begin{sagesilent}
# Define variables and constants/exponents
var('x,y,z')
a1=RandInt(-5,5)
...
\latexProblemContent{
\ifVerboseLocation This is Precalc Compute Question 0079. \\ \fi
\begin{problem}
...
\input{Precalc-Compute-0079.HELP.tex}

\[\mbox{Smaller $x-$value}:\quad\left(\answer{\sage{AnsX1}},\answer{\sage{AnsY1}}\right)\]

\[\mbox{Larger $x-$value}:\quad\left(\answer{\sage{AnsX2}},\answer{\sage{AnsY2}}\right)\]

\end{problem}}%}
%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%
%%\tagged{Ans@ShortAns, Type@Compute, Topic@Precalc, Sub@Nonlinear, Sub@SystemOfEquations, File@0080}{
\begin{sagesilent}
# Define variables and constants/exponents
var('x,y,z')
r=RandInt(2,6)
...
Solve the system of equations
\[\left\lbrace \begin{array}{c}%cl}
\sage{DisplayF1}\\%\sage{f1} & = & \sage{r^2}\\
\sage{DisplayF2}%\sage{f2} & = & \sage{a^2*b^2}
\end{array}\right.\]

\input{Precalc-Compute-0080.HELP.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%
%%\tagged{Ans@ShortAns, Type@Compute, Topic@Precalc, Sub@PartialFractions, File@0081}{
\begin{sagesilent}
# Define variables and constants/exponents
var('x,y,z')
a=RandInt(-5,5)
...
\latexProblemContent{
\ifVerboseLocation This is Precalc Compute Question 0081. \\ \fi
\begin{problem}

Find the partial fraction decomposition of $\sage{f}$.

\input{Precalc-Compute-0081.HELP.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%
%%\tagged{Ans@ShortAns, Type@Compute, Topic@Precalc, Sub@PartialFractions, File@0082}{
\begin{sagesilent}
# Define variables and constants/exponents
var('x,y,z')
a=RandInt(-5,5)
...
\latexProblemContent{
\ifVerboseLocation This is Precalc Compute Question 0082. \\ \fi
\begin{problem}

Find the partial fraction decomposition of $\sage{f}$.

\input{Precalc-Compute-0082.HELP.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%
%%\tagged{Ans@ShortAns, Type@Compute, Topic@Precalc, Sub@Domain, Func@Radical, Func@Poly, File@1000}{
\begin{sagesilent}
# Define variables and constants/exponents
...
\input{Precalc-Compute-1000.HELP.tex}
