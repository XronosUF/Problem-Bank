...
\[\int{\sage{a}\tan^{\sage{b}}(x)\sec^{\sage{pwrEven}}(x)\;dx} = \answer{\sage{Ans}+C}\]
\end{problem}}%}
%%%%%%%%%%%%%%%%%%%%%%
...
\[
\int{\sage{a}\tan^{\sage{pwrOdd1}}(x)\sec^{\sage{pwrOdd2}}(x)\;dx} = \answer{\sage{Ans}+C}
\]
\end{problem}}%}
%%%%%%%%%%%%%%%%%%%%%%
...
\[
\int{\sage{a}\tan^{\sage{pwrEven}}(x)\sec^{\sage{pwrOdd}}(x)\;dx} = \answer{\sage{Ans}+C}
\]
\end{problem}}%}
%%%%%%%%%%%%%%%%%%%%%%
...
Evaluate the integral. \\
\[
\int \left(\sage{Integrand}\right)^{\sage{Integrandpower}} dx=\answer{\sage{ans}}
\]
...
\[
\int \sage{Integrand} dx=\answer{\sage{ans}}
\]
