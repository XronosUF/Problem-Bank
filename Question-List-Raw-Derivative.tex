...
%%%%%%%%%%%%%%%%%%%%%%%
%\tagged{Ans@ShortAns, Type@Compute, Topic@Derivative, Sub@Chain-Rule, Func@Trig, File@0002}{
\begin{sagesilent}
w0=SR.wild(0)
def TrigSimp(f):
    ftemp = f
...
%%%%%%%%%%%%%%%%%%%%%%%
%\tagged{Ans@ShortAns, Type@Compute, Topic@Derivative, Sub@Chain-Rule, Func@Trig, Sub@Product-Rule, File@0003}{
\begin{sagesilent}
w0=SR.wild(0)
def TrigSimp(f):
    ftemp = f
...
%%%%%%%%%%%%%%%%%%%%%%%
%\tagged{Ans@ShortAns, Type@Compute, Topic@Derivative, Sub@Chain-Rule, Sub@Rational, Sub@Quotient-Rule, File@0004}{
\begin{sagesilent}
...
Does the function $\sage{F}$ satisfy the conditions of the Mean Value Theorem (MVT) over the interval $\left[\sage{Lpt},\sage{Rpt}\right]$?

\input{Derivative-Compute-0052.HELP.tex}

\begin{multipleChoice}
\choice{No, the function is not continuous over the closed interval $\left[\sage{Lpt},\sage{Rpt}\right]$}
\choice{No, the function is not differentiable over the open interval $\left[\sage{Lpt},\sage{Rpt}\right]$}
\choice{No, the function is not defined over the interval $\left[\sage{Lpt},\sage{Rpt}\right]$}
...
\[
    f(x)
    =
    \frac{\sage{coef}}{\sqrt{\sage{func2}}}
\]
\[
    f'(x)
    =
...
%%%%%%%%%%%%%%%%%%%%%%%
%%\tagged{Topic@Derivative, Ans@ShortAns, Type@Compute, Func@Rational, Sub@Motion, Sub@Application, File@1004}{
\begin{sagesilent}
...
\latexProblemContent{
\ifVerboseLocation This is Derivative Compute Question 1004. \\ \fi
\begin{problem}

The displacement (in meters) of a particle moving in a straight line is given by the equation of motion $s = \sage{coef}/t^2$, where $t$ is measured in seconds. Find the velocity of the particle at time $t = a$, $t = 1$, $t = 2$, and $t = 3$.

\input{Derivative-Compute-1004.HELP.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%
%%\tagged{Topic@Derivative, Ans@ShortAns, Type@Compute, Sub@Tan-Line, File@1005}{
\begin{sagesilent}

xVal = RandInt(-9,9)
yVal = RandInt(-9,9)
slope = NonZeroInt(-10,10)

ans = slope * (x - xVal) + yVal

\end{sagesilent}

\latexProblemContent{
\ifVerboseLocation This is Derivative Compute Question 1005. \\ \fi
\begin{problem}

Find the equation of the tangent line to the graph of $g(x)$ at $x = \sage{xVal}$ if $g(\sage{xVal}) = \sage{yVal}$ and $g'(\sage{xVal}) = \sage{slope}$.

\input{Derivative-Compute-1005.HELP.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%
%%\tagged{Ans@ShortAns, Type@Compute, Topic@Derivative, Func@Radical, Sub@Linear-Approx, File@1008}{
\begin{sagesilent}
...
\latexProblemContent{
\ifVerboseLocation This is Derivative Compute Question 1008. \\ \fi
\begin{problem}

Find the linear approximation of the function $f(x) = \sage{func}$ at $a = \sage{a}$ and use it to approximate the numbers $\sqrt{\sage{pointOne}}$ and $\sqrt{\sage{pointTwo}}$.

\input{Derivative-Compute-1008.HELP.tex}

\[
    L(x)
    = 
    \answer{\sage{linearization}}
\]
\begin{problem}
...
%%%%%%%%%%%%%%%%%%%%%%%
%%\tagged{Ans@ShortAns, Type@Compute, Topic@Derivative, Func@Radical, Sub@Linear-Approx, File@1009}{
\begin{sagesilent}
...
\latexProblemContent{
\ifVerboseLocation This is Derivative Compute Question 1009. \\ \fi
\begin{problem}

Find the linear approximation of the function $f(x) = \sage{func}$ at $a = \sage{a}$ and use it to approximate the numbers $\cos\left(\sage{pointOne}\right)$ and $\cos\left(\sage{pointTwo}\right)$.

\input{Derivative-Compute-1009.HELP.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%
%%\tagged{Ans@ShortAns, Type@Compute, Topic@Derivative, Func@Poly, Sub@Motion, Sub@Application, File@1010}{
\begin{sagesilent}
...
\latexProblemContent{
\ifVerboseLocation This is Derivative Compute Question 1010. \\ \fi
\begin{problem}

The position $s(t)$ of a robot moving along a track at time $t$ is given by $s(t) = \sage{pos}$. What is the velocity $v(t)$ of the particle at time $t$?

\input{Derivative-Compute-1010.HELP.tex}
...
Find the total distance travelled by the robot between $t = \sage{distLeft}$ and $t = \sage{distRight}$.

\[
    \answer{\sage{distTravelled}}.
\]

\begin{problem}

What is the acceleration $a(t)$ of the particle at time $t$?
\[
    a(t)
    =
    \answer{\sage{accel}}
...
On which interval is the robot speeding up?
\[
    \left(\answer{\sage{speedingLeft}},\answer{\sage{speedingRight}}\right).
\]
...
%%%%%%%%%%%%%%%%%%%%%%%
%%\tagged{Ans@ShortAns, Type@Compute, Topic@Derivative, Func@Poly, Sub@Motion, Sub@Application, File@1011}{
\begin{sagesilent}
...
v = 2*a*t + b
peakTime = -b/(2*a)
peakHeight = h.subs(t=peakTime)

# a = 2*a
\end{sagesilent}

\latexProblemContent{
\ifVerboseLocation This is Derivative Compute Question 1011. \\ \fi
\begin{problem}

At time $t = 0$, a cannonball is launched, with its height $h$ in meters given by $h(t) = \sage{h}$.
At what time $t$ does the cannonball reach its peak?

\input{Derivative-Compute-1011.HELP.tex}

\[
    \text{peak time $t$}
    = 
    \answer{\sage{peakTime}}
\]
\begin{problem}

What is the height of the cannonball at its peak?
\[
    \text{peak time $t$}
    = 
    \answer{\sage{peakHeight}}
\]
\end{problem}
\end{problem}}%}
%%%%%%%%%%%%%%%%%%%%%%