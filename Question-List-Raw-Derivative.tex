...
A snowball is melting at a rate of $\sage{dV}\pi$ $\sagem{unit}^3/s \sagem{unitdesc}$.  At what rate is the radius decreasing when the volume of the snowball is $\sage{V}\pi$ $\sage{unit}^3$?\\[0.5in]

\input{Derivative-Compute-0029.HELP.tex}

The radius is decreasing at $\answer{\sage{Ans}}$ $\sagem{unit}/s$.
\end{problem}}%}
%%%%%%%%%%%%%%%%%%%%%%
