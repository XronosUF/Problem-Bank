...
A snowball is melting at a rate of $\sage{dV}\pi$ $\sagestrmm{unit}^3/s \sagestrmm{unitdesc}$.  At what rate is the radius decreasing when the volume of the snowball is $\sage{V}\pi$ $\sagestrmm{unit}^3$?\\[0.5in]

\input{Derivative-Compute-0029.HELP.tex}

The radius is decreasing at $\answer{\sage{Ans}}$ $\sagestrmm{unit}/s$.
\end{problem}}%}
%%%%%%%%%%%%%%%%%%%%%%
...
A road running north to south crosses a road going east to west at the point $P$.  Cyclist $A$ is riding north along the first road, and cyclist $B$ is riding east along the second road.  At a particular time, cyclist $A$ is $\sage{Da}$ \sagestr{unit} to the north of $P$ and traveling at $\sage{A}$ \sagestr{speed}, while cyclist $B$ is $\sage{Db}$ \sagestr{unit} to the east of $P$ and traveling at $\sage{B}$ \sagestr{speed}.  How fast is the distance between the two cyclists changing? \\[0.5in]

\input{Derivative-Compute-0031.HELP.tex}

The distance between the two cyclists is increasing by $\answer{\sage{Ans}}$ \sagestr{speed}.
\end{problem}}%}
%%%%%%%%%%%%%%%%%%%%%%
...
A swing consists of a board at the end of a $\sage{A}$ \sagestr{unit} long rope.  Think of the board as a point $P$ at the end of the rope, and let $Q$ be the point of attachment at the other end.  Suppose that the swing is directly below $Q$ at time $t=0$, and is being pushed by someone who walks at $\sage{B}$ \sagestr{unit} per second from left to right.  What is the angular speed of the rope in rad/s after 1 sec? \\[0.5in]
...
\[
\text{Inflection points at } x=\answer{\sage{Ans}}
\]
\end{problem}}%}
%%%%%%%%%%%%%%%%%%%%%%
